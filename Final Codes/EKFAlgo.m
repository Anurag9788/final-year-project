function EKFAlgo(handles,FilePath)
...
%          'LineWidth',2,'LineStyle','--')
   ...
   %......................DWT...................................
   GetSubspaceFeatureVector_DWT(T_Org_Gray);
   x=x0;
   y=y0;
   position = [x0,y0];
            corner_list = [x0, y0] ;
   ...
   [ x,y,bplot ] = GetNewPositionBy_DWT(handles,frame,x,y,H,W,T_Org);
   position = [x,y];
                corner_list = [corner_list; x, y] ;
...
dlmwrite('tracked_corners.txt', corner_list) ;
